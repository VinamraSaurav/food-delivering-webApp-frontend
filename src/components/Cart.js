...
export default function Cart() {
  return (
    <div className="Cart-page m-3 mb-6 mt-[90px] ">
      ...
      <img
          ...
          />
        <div class="construction-container max-w-[500px] mx-auto">
          
          <h1 class="construction-heading text-[#e44d26] font-bold text-lg">Under Construction</h1>
          <p class="construction-message mt-2 text-left">
          ...
          <p class="construction-progress mb-5 text-left">
